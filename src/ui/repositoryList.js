                          ...
                          <tr key={entry.id}>
                            ...
                            <td>
                              <Button
                                ...
                                onClick={() => {issueObject.mode="open"; issueObject.repo=entry.name; issueObject.number=""; issueObject.title=""; issueObject.body=""; issueObject.state="open"; viewStore.push(viewStore.routes.issue())}}
                                text="open"
                              />
                            </td>
                            <td>
